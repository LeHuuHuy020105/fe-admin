...
export default function ActivityFeed() {
    const activities = [
            ...
            bgColor:"bg-blue-100 dark:bg-blue-900/30"},
        {
            ...
            description: "Order #OD1234 has been placed.",
            time: "3 hours ago",
            ...
            bgColor:"bg-green-100 dark:bg-green-900/30"},
        {
            ...
            description: "Total revenue has increased by 5%.",
            time: "5 hours ago",
  ...
  return (
    ...
    border-slate-200/50 dark:border-slate-700/50'>
        <div className='p-6 border-b border-slate-200/50 dark:border-slate-700/50'>
            ...
            <button className='text-blue hover:text-blue-700 text-sm font-medium'></button>
        </div>

        <div className='p-6'>
            {activities.map((activity)=>(<div className='space-y-4'>
